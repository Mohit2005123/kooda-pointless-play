...
function injectWow() {
  ...
  if (isFibonacci(Koodas)) {
    fibonacciWows.push(newWow)
  }

  if (wows === 10) {
    lengthEl.innerText = "kooda kooda"
  }

  if (wows === 50) {
    lengthEl.innerText = "kooda kooda kooda"
  }

  if (wows === 100) {
    lengthEl.innerText = "much kooda"
  }

  if (wows === 150) {
    lengthEl.innerText = "long much kooda"
  }

  if (wows === 250) {
    lengthEl.innerText = "very long much kooda"
  }

  if (wows === 500) {
    lengthEl.innerText = "kooda very long much kooda"
  }

  if (wows === 1000) {
    lengthEl.innerText = "much kooda very long much kooda!"
  }
  ...
  if (wows === 10000) {
    lengthEl.innerText = "many many kooda amaze"
  }

  if (wows === 30000) {
    lengthEl.innerText = "amaze kooda dont forget to print!"
  }

  if (wows === 50000) {
    lengthEl.innerText = "koodakoodakoodakoodakoodakoodakoodakoodakoodakoodakoodakooda"
  }

  if (wows === 80000) {
    lengthEl.innerText = "koodakoodakoodakoodakoodakoodakoodakoodakoodakoodakoodakoodaeeeeeeeeee"
  }
...
function setupSecretWows() {
  ...
  '<span class="secretwow">kooda</span>' +
